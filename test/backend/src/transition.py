...
async def transition(oldImage: Image.Image, newImage: Image.Image):
...
if __name__ == "__main__":
    img1 = Image.open(INPUT_IMG1_PATH)
    img2 = Image.open(INPUT_IMG2_PATH)
    result = asyncio.run(transition(img1, img2))